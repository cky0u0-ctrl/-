...
filterBtns.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        let cataType = btn.getAttribute("data-filter");
        console.log(cataType);
        // 모든 버튼은active 클래스가 사라지고
...
function renderMenu(cate) {
    ...
    let filterMenus = cate === "all" ? allMenuItems : allMenuItems.filter(item => item.category === cate);
